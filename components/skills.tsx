...
export className SkillsCard extends Component<{ key: any, percentage: any, text: any }> {
    render() {
        ...
        return (
            <div key={key} className={"w-max  grid place-items-center h-full"}>
                <div className={"w-44 h-44 m-0  rounded-progress grid place-items-center"}>
                    <div
                        className=" flex justify-center items-center align-middle m-0"
                    >
                        <svg
                            className="relative w-32 h-32 progress-ring"
                        >
                            <text x="50%" y="50%" textAnchor="middle" dy="0em" dx="-0.1em" fill="white" fontSize="16">
                                {percentage}%
                            </text>
                            <text x="50%" y="50%" textAnchor="middle" dy="1.5em" fill="white" fontSize="15">
                                {text}
                            </text>
                            <circle
                    ...
                    <p className={"text-white  left-[35%] top-[0px] text-2xl font-extrabold"}></p>
...
export default function Skills() {
    return (
        <div className={" bg-[#1f1f1f]  relative flex-col justify-center items-center flex h-max pb-44"} id={"skills"}>
            ...
            <div className={"w-full flex flex-col relative justify-center items-center"}>
                <p className={"text-4xl text-center text-white font-extrabold w-1/2 h-24"}>Coolest Ever</p>
