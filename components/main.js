...
export default function Main() {
    ...
    useEffect(() => {
        const typed = new Typed(el.current, {
            strings: [
                "Hi , I am Rohith Krishnan", " Based in India.", "I'm a web-developer and ML enthusiast."
            ],
            typeSpeed: 50,
            startDelay: 1500,
            loop: true,
    ...
    return (
        ...
        >
            <div className={"md:w-2/3 w-full flex justify-center gap-4 main-one items-center flex-col"}>
