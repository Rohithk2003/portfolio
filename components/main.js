        ...
        >
            <div className={"w-2/3 flex justify-center gap-4 items-center flex-col"}>
                <div className={"flex justify-start w-1/2"}>
                    <div className={"w-24 h-24  rounded-full overflow-hidden object-bottom relative "}>
                        <Image m run dev
                               src={"/portfolio/main.png"}
                               alt={"profile_photo w-full h-full"} style={{
                ...
                <div className={" w-1/2 text-[#454545] "}>
                    Currently working on <span className={"text-white"}>being a better person and a developer</span>
                </div>
                <div className={"text-lg text-white text-start w-1/2 flex justify-start"}>
                    Top Skills
                </div>
                <ul className={"flex flex-row gap-4 text-[#585858] flex-wrap w-1/2 justify-start items-center"}>
                    <li>Next.js</li>
                    <li>Django</li>
                    <li>PostgresSQL</li>
