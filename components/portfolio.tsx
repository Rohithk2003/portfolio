...
export default function Portfolio() {
    return (
        <div className={" bg-[#222222]  relative flex-row w-full h-[100vh]"} id={"services"}>
            <p className={"text-sm underline text-center pt-16 text-[#f16b4b] font-extrabold w-full h-24"}>Portfolio</p>
            <p className={"text-4xl  text-center text-white font-extrabold w-full h-24"}>Creative Works</p>
